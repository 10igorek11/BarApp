...
class CreateLearningMaterialUseCase @Inject constructor(
    private val learningMaterialRepository: LearningMaterialRepository
) {
    suspend operator fun invoke(learningMaterial: LearningMaterialDto) = learningMaterialRepository.createLearningMaterial(learningMaterial)
}